...
function LeftSection({Image, head, para, TryDemo, LearnMore, coin, kiteconnect, GPlay, AppStore}) {
    return ( 
        <div className="container mt-5 mx-5">
            <div className="row mt-5 mx-5">
                <div className="col mt-5 mx-4" style={{display:"flex", flexDirection:"column", justifyContent:"center"}}>
                    <h1 className="mt-5  fs-3 text-muted">{head}</h1>
                    <p className="mt-2  fs-6 text-muted">{para}</p>
                    <div className="mt-3">
                        ...
                        {kiteconnect && <a href={kiteconnect}>Kite Connect <i class="fa-solid fa-arrow-right"></i></a>}
                    </div>
                    <div className="mt-4">
                    {GPlay && <a href={GPlay}><img src="media\images\googlePlayBadge.svg" alt="" /></a>}
                    {AppStore && <a href={AppStore}><img src="media\images\appstoreBadge.svg" alt=""/></a>}
                    </div>
                </div>
